...
#------------------------------------------------------------------------------
# PROGRAM: glosat-gmted-haversine.py
#------------------------------------------------------------------------------
# Version 0.2
# 9 September, 2020
# Michael Taylor
...
print('plotting GloSAT-GMTED2010 elevation differences for 3x3 nearest grid points ...')
...
print('plotting GloSAT-GMTED2010 latitude differences for 3x3 nearest grid points ...')
...
print('plotting GloSAT-GMTED2010 longitude differences for 3x3 nearest grid points ...')
